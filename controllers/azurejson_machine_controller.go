...
func (r *AzureJSONMachineReconciler) Reconcile(ctx context.Context, req ctrl.Request) (_ ctrl.Result, reterr error) {
	...
	log.Info("Reconciling AzureMachine", "name", azureMachine.Name, "namespace", azureMachine.Namespace)
	log.Info("OwnerRefs for AzureMachine", "name", azureMachine.Name, "namespace", azureMachine.Namespace, "ownerRefs", azureMachine.OwnerReferences)
	...
	log.Info("Cluster spec for AzureMachine is", "azureMachine", azureMachine.Name, "cluster", cluster.Name, "clusterSpec", cluster.Spec)
