...
func (m *MockTagsGetter) GetAtScope(ctx context.Context, spec azure0.TagsSpecGetter) (resources.TagsResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAtScope", ctx, spec)
...
func (mr *MockTagsGetterMockRecorder) GetAtScope(ctx, spec interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAtScope", reflect.TypeOf((*MockTagsGetter)(nil).GetAtScope), ctx, spec)
}
