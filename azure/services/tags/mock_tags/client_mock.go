...
func (m *Mockclient) GetAtScope(arg0 context.Context, arg1 tags.TagsSpec) (resources.TagsResource, error) {
	m.ctrl.T.Helper()
...
func (m *Mockclient) UpdateAtScope(arg0 context.Context, arg1 tags.TagsSpec, arg2 resources.TagsPatchResource) (resources.TagsResource, error) {
	m.ctrl.T.Helper()
